...
import 'package:moviedb/utils/DeviceUtils.dart';
import 'package:moviedb/utils/StringUtils.dart';
  ...
  Widget _iOSContent() {
    return FutureBuilder(
        ...
        builder: (context, AsyncSnapshot<IosDeviceInfo> snapshot) {
          ...
          var buildMode = DeviceUtils.currentBuildMode().toString();

          return SingleChildScrollView(
            child: Column(
              children: <Widget>[
                _buildTile('Flavor:', '${FlavorConfig.instance.name}'),
                _buildTile('Build:', '${StringUtils.enumName(buildMode)}'),
